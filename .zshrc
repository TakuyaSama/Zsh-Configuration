...
zstyle :compinstall filename '/home/takuya/.zshrc'

autoload -Uz compinit
compinit
# End of lines added by compinstall
# umask custom configuration
umask 007
# Lines from Anarchy Linux ZSH configuration file
...
RPS1="$PR_LIGHT_YELLOW(%D{%d-%m-%y %r})$PR_NO_COLOR"
unsetopt ALL_EXPORT
...
### Source plugins
##################
source ~/Takuya/Software/powerlevel10k/powerlevel10k.zsh-theme

# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh
source ~/Takuya/Software/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
